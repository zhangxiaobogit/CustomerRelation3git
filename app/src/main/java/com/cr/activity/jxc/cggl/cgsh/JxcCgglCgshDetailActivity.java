...
import static com.cr.activity.jxc.JXC_HTTP_Util.Companion;
...
//        parmMap.put("pkvalue", this.getIntent().getExtras().getString("billid"));
        findServiceData2(3, ServerURL.BILLDELMASTER, (Map<String, Object>) JXC_HTTP_Util.Companion.getInstance().deleteData(ShareUserInfo.getDbName(mContext),
...
//                Constans_HS_JXC.TABLE_NAME_CGSH, this.getIntent().getExtras().getString("billid"), ShareUserInfo.getUserId(mContext)), false);
    }
