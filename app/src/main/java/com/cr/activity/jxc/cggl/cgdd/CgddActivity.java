...
public class CgddActivity extends BaseActivity {
    ...
    LinearLayout ll_xzsp;
    @BindView(R.id.ll_gys)
    LinearLayout ll_gys;
    @BindView(R.id.ll_lxr)
    LinearLayout ll_lxr;
    @BindView(R.id.ll_fplx_xz)
    LinearLayout ll_fplx_xz;
    @BindView(R.id.ll_xgxm)
    LinearLayout ll_xgxm;
    @BindView(R.id.ll_jhrq)
    LinearLayout ll_jhrq;
    @BindView(R.id.ll_zjzh_xz)
    LinearLayout ll_zjzh_xz;
    @BindView(R.id.ll_djrq_xz)
    LinearLayout ll_djrq_xz;
    @BindView(R.id.ll_bm_xz)
    LinearLayout ll_bm_xz;
...
//        }
    ...
    private void isCanEditMethod(boolean isCanEdit) {
        if (!isCanEdit) {
            ...
            etYfje.setEnabled(false);
            ll_xzsp.setEnabled(false);
            etHjje.setEnabled(false);
            etBzxx.setEnabled(false);


            ll_xzsp.setEnabled(false);
            ll_gys.setEnabled(false);
            ll_lxr.setEnabled(false);
            ll_fplx_xz.setEnabled(false);
            ll_xgxm.setEnabled(false);
            ll_jhrq.setEnabled(false);
            ll_zjzh_xz.setEnabled(false);
            ll_djrq_xz.setEnabled(false);
            ll_bm_xz.setEnabled(false);
            ll_jbr.setEnabled(false);
