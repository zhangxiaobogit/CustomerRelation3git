 ...
 */
public class JxcCgglCgthDetailActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_cggl_cgth_detail);
...
//            jhdzEditText.setText(object.get("billto").toString());
            ...
            tkjeEditText.setText(FigureTools.sswrFigure(object.get("receipt").toString()));
            ...
            fklxEditText.setText(object.get("backmoney").toString().equals("1") ? "退还现款" : "冲抵往来");
