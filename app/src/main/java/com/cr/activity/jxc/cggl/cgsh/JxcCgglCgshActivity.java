 ...
 */
public class JxcCgglCgshActivity extends BaseActivity implements OnClickListener {
    private JxcCgglCgshAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_cggl_cgsh);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcCgglCgshAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(mContext, JxcCgglCgshAddActivity.class);
                intent.putExtra("billid", list.get(arg2 - 1).get("billid").toString());
                if (JxcCgglCgshActivity.this.getIntent().hasExtra("select")) {//如果是添加订单时候关联的操作
                    setResult(RESULT_OK, intent);
                    finish();
                } else {//否则就是正常情况的打开
                    intent.putExtra(Constans_JXC.CURRENT_ACTIVITY_NAME, Constans_JXC.CGDD_CHECK_ACTION);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcCgglCgshSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(mContext, JxcCgglCgshAddActivity.class);
                intent.putExtra(Constans_JXC.CURRENT_ACTIVITY_NAME, Constans_JXC.CGDD_ADD_ACTION);
                startActivityForResult(intent, 1);
                break;
        }
    }
