...
import com.cr.adapter.jxc.xsgl.xskd.JxcXsglXskdAdapter;
 ...
 */
public class JxcXsglXskdActivity extends BaseActivity implements OnClickListener {
    private JxcXsglXskdAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_xsgl_xskd);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcXsglXskdAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                if (JxcXsglXskdActivity.this.getIntent().hasExtra("select")) {//如果是添加订单时候关联的操作
...
//                    startActivityForResult(intent,1);
                    Intent intent = new Intent(mContext, JxcXsglXskdAddActivity.class);
                    intent.putExtra(Constans_JXC.CURRENT_ACTIVITY_NAME, Constans_JXC.XSKD_CHECK_ACTION);
                    intent.putExtra("billid", list.get(arg2 - 1).get("billid").toString());
                    startActivityForResult(intent, 1);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcXsglXskdSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.putExtra(Constans_JXC.CURRENT_ACTIVITY_NAME, Constans_JXC.XSKD_ADD_ACTION);
                intent.setClass(mContext, JxcXsglXskdAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
